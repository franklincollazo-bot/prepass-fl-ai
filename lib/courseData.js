...
export const CHAPTERS_DATA = {
  ...
  2: {
    ...
    subtopics: [
      ...
      {
        id: "2.4",
        title: "2.4 Cuidados a Largo Plazo (LTC)",
        videoUrl: "https://app.heygen.com/embeds/1a4ddedab031460b9cda0f4d8b4d58ba",
        summary: "Niveles de cuidado (Skilled, Intermediate, Custodial) y ADLs."
      }
    ]
  },
  3: {
    ...
    subtopics: [
      ...
      },
      {
        ...
        videoUrl: "https://app.heygen.com/embeds/07c0bb2635ea499ab13944b9a5bc80a6",
        summary: "Cláusulas de renovabilidad (No cancelable, garantizada) y aseguramiento."
      }
    ]
  },
  4: {
  ...
  7: {
    ...
    subtopics: [
      {
        id: "7.1",
        title: "7.1 Provisiones y Coberturas Obligatorias en Florida",
        videoUrl: "https://app.heygen.com/embeds/90ba7f1ff7414109a0c6a76f0b0295ce",
        summary: "Periodos de gracia específicos, Maternidad (48/96h), Recién nacidos (31 días), Hijos incapacitados y Coberturas obligatorias (Diabetes, Mamografía, Mastectomía)."
      },
      {
        id: "7.2",
        title: "7.2 Leyes de Mercado y Grupos Pequeños",
        videoUrl: "https://app.heygen.com/embeds/9e71c1c8f8a8450aab0bf7a81ad91dfa",
        summary: "Small Employer Health Care Act (1-50 empleados), Mini-COBRA FL (18 meses), Florida Healthy Kids y Reglas de Publicidad."
      }
    ]
  }
};
...
export const QUESTIONS_POOL = {
  ...
  6: [
    ...
    { id: 611, topic: "Ética", question: "El acto de convencer a un asegurado de usar el valor de su póliza para comprar otra con la misma compañía se llama:", options: ["Twisting", "Rebating", "Churning", "Sliding"], answer: "Churning" },
    ...
    { id: 613, topic: "Reguladores", question: "La Office of Insurance Regulation (OIR) es responsable de todo lo siguiente, EXCEPTO:", options: ["Aprobar tarifas", "Emitir licencias de agentes", "Aprobar formularios de pólizas", "Supervisar la solvencia de aseguradoras"], answer: "Emitir licencias de agentes" },
    { id: 614, topic: "Ética", question: "Difamación se define como:", options: ["Hacer declaraciones falsas sobre la competencia", "Dar regalos a clientes", "Mentir en la aplicación", "Cambiar al beneficiario sin permiso"], answer: "Hacer declaraciones falsas sobre la competencia" },
    { id: 615, topic: "Licencias", question: "Para obtener una licencia de agente en Florida, el solicitante debe tener al menos:", options: ["18 años", "21 años", "25 años", "No hay edad mínima"], answer: "18 años" },
    { id: 616, topic: "Sanciones", question: "La multa administrativa máxima por una violación intencional del Código de Seguros de Florida es generalmente de:", options: ["$5,000", "$10,000", "$50,000", "$250,000"], answer: "$250,000" },
    { id: 617, topic: "Agencia", question: "Un agente actúa como un fiduciario porque:", options: ["Es un oficial de la corte", "Maneja dinero de primas para la aseguradora", "Vende muchos tipos de seguros", "Vive en Florida"], answer: "Maneja dinero de primas para la aseguradora" },
    { id: 618, topic: "Ética", question: "Ofrecer algo de valor que no está especificado en el contrato de seguro para inducir la venta es:", options: ["Coerción", "Rebating", "Sliding", "Twisting"], answer: "Rebating" },
    { id: 619, topic: "Contratos", question: "Un contrato de seguro es un contrato de Adhesión porque:", options: ["Ambas partes negocian", "La aseguradora redacta el contrato y el asegurado lo acepta 'tal cual'", "Se basa en la suerte", "Es verbal"], answer: "La aseguradora redacta el contrato y el asegurado lo acepta 'tal cual'" },
    { id: 620, topic: "Ética", question: "Usar fuerza o amenazas para restringir el comercio de seguros es:", options: ["Coerción", "Boicot", "Intimidación", "Todas las anteriores"], answer: "Todas las anteriores" },
    { id: 621, topic: "Nombramientos", question: "¿Cuántos nombramientos puede tener un agente?", options: ["Solo uno", "Máximo tres", "Sin límite, mientras esté autorizado", "Uno por año"], answer: "Sin límite, mientras esté autorizado" },
    { id: 622, topic: "Licencias", question: "Un agente no residente en Florida debe:", options: ["Mudarse a Florida", "Tener licencia en su estado natal", "Pagar impuestos dobles", "Tener un título universitario"], answer: "Tener licencia en su estado natal" },
    { id: 623, topic: "CFO", question: "El CFO es elegido por un término de:", options: ["2 años", "4 años", "6 años", "De por vida"], answer: "4 años" },
    { id: 624, topic: "Reglas", question: "Toda la publicidad de seguros es responsabilidad legal de:", options: ["El Agente", "La Aseguradora", "El examinador", "Vercel"], answer: "La Aseguradora" },
    { id: 625, topic: "Ética", question: "Apropiarse de dinero de primas de un cliente es:", options: ["Deducible", "Lícito", "Un delito de Hurto (Theft)", "Una práctica común"], answer: "Un delito de Hurto (Theft)" }
,
  ...
  7: [
        { id: 701, topic: "Salud Florida", question: "¿Cuál es el periodo de gracia en Florida para una póliza de salud individual con prima mensual?", options: ["7 días", "10 días", "31 días", "45 días"], answer: "10 días" },
    { id: 702, topic: "Maternidad", question: "En Florida, la estancia mínima obligatoria tras un parto natural sin complicaciones es de:", options: ["24 horas", "48 horas", "72 horas", "96 horas"], answer: "48 horas" },
    { id: 703, topic: "Small Group", question: "Bajo la Ley de Cuidado de Salud de Florida, un 'Pequeño Empleador' tiene entre:", options: ["1 y 25 empleados", "1 y 50 empleados", "1 y 100 empleados", "20 y 50 empleados"], answer: "1 y 50 empleados" },
    { id: 704, topic: "LTC Florida", question: "¿Cuál es el periodo de examen libre (Free Look) para pólizas LTC en Florida?", options: ["10 días", "20 días", "30 días", "45 días"], answer: "30 días" },
    { id: 705, topic: "Reglas", question: "La cobertura para un recién nacido en Florida comienza automáticamente:", options: ["A los 30 días", "Tras el pago de la primera prima", "En el momento del nacimiento", "Tras la notificación al DFS"], answer: "En el momento del nacimiento" },
    ...
    { id: 707, topic: "Small Group", question: "La ley de Continuación de Salud de Florida (Mini-COBRA) aplica a grupos de hasta:", options: ["10 empleados", "19 empleados", "50 empleados", "100 empleados"], answer: "19 empleados" },
    ...
    { id: 711, topic: "Niños", question: "¿Dentro de cuántos días debe notificarse a la aseguradora el nacimiento de un hijo para continuar la cobertura?", options: ["10 días", "15 días", "31 días", "60 días"], answer: "31 días" },
    { id: 712, topic: "Florida Healthy Kids", question: "El programa Florida Healthy Kids es financiado por:", options: ["Solo fondos privados", "Fondos estatales, federales y primas familiares", "Solo el Departamento de Salud", "Donaciones"], answer: "Fondos estatales, federales y primas familiares" },
    { id: 713, topic: "Maternidad", question: "La estancia mínima para un parto por cesárea en Florida es de:", options: ["48 horas", "72 horas", "96 horas", "120 horas"], answer: "96 horas" },
    { id: 714, topic: "Small Group", question: "Para ser elegible en un plan de grupo pequeño en Florida, un empleado debe trabajar al menos:", options: ["15 horas/semana", "20 horas/semana", "25 horas/semana", "40 horas/semana"], answer: "25 horas/semana" },
    { id: 715, topic: "Medigap", question: "En Florida, el periodo de Free Look para un Suplemento de Medicare es de:", options: ["10 días", "20 días", "30 días", "45 días"], answer: "30 días" },
    { id: 716, topic: "Ética", question: "¿Qué título tiene prohibido usar un agente de salud en Florida si no tiene licencias financieras?", options: ["Especialista en Seguros", "Financial Planner (Planificador Financiero)", "Agente de Salud", "Consultor de Beneficios"], answer: "Financial Planner (Planificador Financiero)" },
    { id: 717, topic: "Publicidad", question: "¿Quién es el responsable legal final de la publicidad de seguros en Florida?", options: ["El Agente", "El examinador", "La Aseguradora", "La agencia de publicidad"], answer: "La Aseguradora" },
    { id: 718, topic: "LTC Partnership", question: "El propósito del LTC Partnership Program en Florida es:", options: ["Reducir las primas", "Proteger activos para calificar para Medicaid", "Pagar beneficios de Medicare", "Eliminar el deducible"], answer: "Proteger activos para calificar para Medicaid" },
    { id: 719, topic: "Elegibilidad", question: "Un hijo dependiente incapacitado puede permanecer en la póliza de sus padres:", options: ["Hasta los 26 años", "Hasta los 30 años", "Indefinidamente mientras dependa de ellos", "Solo si paga prima extra"], answer: "Indefinidamente mientras dependa de ellos" },
    { id: 720, topic: "Divulgación", question: "El 'Outline of Coverage' debe entregarse al cliente:", options: ["Solo si lo pide", "Un año después", "Al momento de la aplicación o entrega de póliza", "Por correo certificado únicamente"], answer: "Al momento de la aplicación o entrega de póliza" },
    { id: 721, topic: "Mastectomía", question: "Las pólizas de salud en Florida que cubren mastectomías también deben cubrir:", options: ["Cirugía estética no relacionada", "Prótesis y reconstrucción mamaria", "Solo la cirugía inicial", "Cualquier otra cirugía plástica"], answer: "Prótesis y reconstrucción mamaria" },
    { id: 722, topic: "Publicidad", question: "En Florida, se prohíbe el uso de qué palabra de forma engañosa en la publicidad:", options: ["Seguro", "Garantizado", "Póliza", "Beneficio"], answer: "Garantizado" },
    { id: 723, topic: "Florida Healthy Kids", question: "¿Para quién es Florida Healthy Kids?", options: ["Niños indigentes", "Niños que no califican para Medicaid pero ganan poco para seguro privado", "Hijos de agentes de seguros", "Niños con enfermedades raras únicamente"], answer: "Niños que no califican para Medicaid pero ganan poco para seguro privado" },
    { id: 724, topic: "Mini-COBRA", question: "La notificación de Mini-COBRA debe enviarse al empleado dentro de los:", options: ["10 días", "14 días", "31 días", "45 días"], answer: "14 días" },
    { id: 725, topic: "Hijos Adoptados", question: "La cobertura para un hijo adoptado en Florida comienza:", options: ["Tras 6 meses", "En el momento de la ubicación legal (Placement)", "Al cumplir 1 año", "Cuando el DFS lo autorice"], answer: "En el momento de la ubicación legal (Placement)" }
,
...
export const MASTERCLASS_METADATA = {
  ...
  '6.1': [
    { start: 30, end: 60, type: 'concept', title: 'EL CFO', text: 'Oficial electo que supervisa el Departamento de Servicios Financieros (DFS).' },
    { start: 70, end: 100, type: 'concept', title: 'LA OIR', text: 'Encargada de la solvencia financiera de las compañías y aprobación de tarifas.' },
    { start: 110, end: 140, type: 'trap', title: 'DFS vs OIR', text: 'DFS licencia AGENTES. OIR regula COMPAÑÍAS.' }
  ],
  '6.2': [
    { start: 20, end: 50, type: 'trap', title: 'SLIDING', text: 'Decir que una cobertura es obligatoria por ley cuando no lo es.' },
    { start: 60, end: 90, type: 'trap', title: 'TWISTING', text: 'Mentir sobre la competencia para inducir un reemplazo.' },
    { start: 100, end: 130, type: 'trap', title: 'CHURNING', text: 'Reemplazo innecesario con la misma compañía para ganar comisión.' },
    { start: 140, end: 170, type: 'concept', title: 'COMMINGLING', text: 'Mezclar dinero de primas con fondos personales. ILEGAL.' }
  ],
  '7.1': [
    { start: 30, end: 60, type: 'concept', title: 'MATERNIDAD FL', text: 'Estancia mínima: 48h Parto Natural / 96h Cesárea.' },
    { start: 70, end: 100, type: 'trap', title: 'RECIÉN NACIDOS', text: 'Cobertura automática al nacer. 31 días para notificar y pagar.' },
    { start: 110, end: 140, type: 'concept', title: 'HIJOS INCAPACITADOS', text: 'Continúan en la póliza tras los 26 años si dependen del padre.' }
  ],
  '7.2': [
    { start: 20, end: 50, type: 'concept', title: 'SMALL GROUP ACT', text: 'Pequeño empleador: 1 a 50 empleados. Garantía de emisión.' },
    { start: 60, end: 90, type: 'concept', title: 'MINI-COBRA FL', text: 'Grupos de <20 empleados. Continuación por 18 meses.' },
    { start: 100, end: 130, type: 'trap', title: 'FREE LOOK FL', text: 'Medicare Supplement y LTC: 30 DÍAS en Florida.' }
  ]
};
